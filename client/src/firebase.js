import { getFirestore, doc, setDoc, updateDoc, getDocs, getDoc, collection, addDoc, query, where, orderBy, startAfter, limit } from "firebase/firestore"
...
export { db, doc, setDoc, updateDoc, getDocs, getDoc, collection, addDoc, query, where, createUserWithEmailAndPassword, signInWithEmailAndPassword, auth, signOut, getIdToken, orderBy, startAfter, limit};